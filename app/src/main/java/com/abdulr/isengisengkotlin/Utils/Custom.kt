...
class Custom(private val activity: Activity) {
    ...
    private var biometricBuilder: BiometricManager.BiometricBuilder = BiometricManager.BiometricBuilder(activity)
    ...
    fun showBiometricDialog(title: String, subtitle: String, desc: String, callback: BiometricCallback) {
        biometricBuilder.setTitle(title)
    ...
    fun saveToGallery(image: ImageView, title: String, desc: String) {
        image.isDrawingCacheEnabled = true
        val bm = image.drawingCache

        MediaStore.Images.Media.insertImage(activity.contentResolver, bm, title, desc)
    }
}